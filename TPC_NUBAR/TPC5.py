...
def HNL_siren(m4, tr4):
    ...
    # energy distribution
    flux_file = siren.utilities.get_tabulated_flux_file("T2K_NEAR","MINUS_numu")
    ...
    controller.SaveEvents(
        "output/TPC5_Dipole_M%2.2e_mu%2.2e_example"
        % (model_kwargs["m4"], model_kwargs["mu_tr_mu4"]),
        fill_tables_at_exit=True
    )
    
    path="TPC5_Dipole_M%2.2e_mu%2.2e_example.parquet"%(m4,tr4)
...
if __name__ == '__main__':
    ...
    # m_sample = [6.1615502775833431e-01]
    # mu_sample = [4.6415888336127821e-07]
    # Obtain new samples 
