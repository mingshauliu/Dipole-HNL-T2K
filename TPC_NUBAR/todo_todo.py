...
def HNL_siren(exp, m4, tr4):
    if os.path.isfile(f"./output_new/{exp}_Dipole_M{m4:2.2e}_mu{tr4:2.2e}_example.parquet") or exp == 'OGTPC1':
        print(f'{exp} {m:2.2e} {mu:2.2e} DONE or is OGTPC1')
        return f'{exp} {m:2.2e} {mu:2.2e} DONE'
...
if __name__ == '__main__':
    ...
    for exp, m, mu in zip(exps,ms,mus):
        HNL_siren(exp,m,mu)