...
def HNL_siren(m4, tr4):
    ...
    if os.path.exists(f'./output/TPC5_Dipole_M{m4:2.2e}_mu{tr4:2.2e}_example.parquet'):
        return
...
def get_new_sample():
    ...
    for m4, tr4 in zip(m_sample, mu_sample):
        if not os.path.exists(f'./output/TPC5_Dipole_M{m4:2.2e}_mu{tr4:2.2e}_example.parquet'):
...
if __name__ == '__main__':
    ...
    # HNL_siren(m_sample_new[0], mu_sample_new[0])
