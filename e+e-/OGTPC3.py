...
def HNL_siren(m4, tr4):
    ...
    if os.path.exists(f'./output/OGTPC3_Dipole_M{m4:2.2e}_mu{tr4:2.2e}_example.parquet'):
        return
    ...
    try:
        ...
        # energy distribution
        flux_file = siren.utilities.get_tabulated_flux_file("T2K_OLD","PLUS_numu")
        ...
        controller.SaveEvents(
            "output/OGTPC3_Dipole_M%2.2e_mu%2.2e_example"
