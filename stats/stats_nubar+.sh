#!/bin/bash
#SBATCH -n 8                   # Number of cores (-c)
#SBATCH -t 01:00:00              # Runtime in D-HH:MM, minimum of 10 minutes
...
mamba activate /n/holylfs05/LABS/arguelles_delgado_lab/Everyone/msliu/siren_dn

# Run your job, outputting results to SCRATCH
python3 stats_mult_nubar_+.py
