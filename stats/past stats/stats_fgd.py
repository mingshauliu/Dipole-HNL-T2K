...
def load_data(exp, m, mu, POT):
    ...
    if os.path.isfile('../output_final/' + path):
        data = ak.from_parquet("../output_final/" + path)
...
def write_signal_strength(exp, i, m, mu, signal_strength, filename="signal_fgd_nd280.csv"):
