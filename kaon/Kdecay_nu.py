...
def generate_hnl_events(m, U, events_to_inject=100000, experiment="OGTPC1"):
    ...
    path="OGTPC1_Dipole_M%2.2e_Ue%2.2e_example.parquet"%(m,U)
    ...
    controller.SaveEvents(f"output_nu/{experiment}_Dipole_M{m:.2e}_Ue{U:.2e}_example", fill_tables_at_exit=True, save_int_probs=True)
